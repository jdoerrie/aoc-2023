...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `63.3µs` | `280.9µs` |
| [Day 2](./src/bin/02.rs) | `35.2µs` | `32.6µs` |
| [Day 3](./src/bin/03.rs) | `431.3µs` | `351.2µs` |
| [Day 4](./src/bin/04.rs) | `219.1µs` | `207.8µs` |
| [Day 5](./src/bin/05.rs) | `38.4µs` | `86.0µs` |
| [Day 6](./src/bin/06.rs) | `388.0ns` | `326.0ns` |
| [Day 7](./src/bin/07.rs) | `419.9µs` | `395.7µs` |
| [Day 8](./src/bin/08.rs) | `81.3µs` | `511.9µs` |
| [Day 9](./src/bin/09.rs) | `277.4µs` | `264.0µs` |
| [Day 10](./src/bin/10.rs) | `3.5ms` | `5.6ms` |
| [Day 11](./src/bin/11.rs) | `96.3µs` | `87.4µs` |
| [Day 12](./src/bin/12.rs) | `178.1µs` | `763.9µs` |
| [Day 13](./src/bin/13.rs) | `211.2µs` | `6.5ms` |
| [Day 14](./src/bin/14.rs) | `39.0µs` | `13.4ms` |
| [Day 15](./src/bin/15.rs) | `56.9µs` | `152.0µs` |
| [Day 16](./src/bin/16.rs) | `124.2µs` | `4.5ms` |
