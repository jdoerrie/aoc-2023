...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `58.5µs` | `283.1µs` |
| [Day 2](./src/bin/02.rs) | `34.4µs` | `32.5µs` |
| [Day 3](./src/bin/03.rs) | `422.0µs` | `362.0µs` |
| [Day 4](./src/bin/04.rs) | `215.9µs` | `213.4µs` |
| [Day 5](./src/bin/05.rs) | `36.2µs` | `85.8µs` |
